                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="{{ route('courses.english') }}">English</a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="row mb-4">
            <div class="col-md-6 mb-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">Master the art of understanding and analyzing texts through proven reading
            ...
            <div class="col-md-6 mb-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">Enhance your writing skills and expand your vocabulary for effective
                            communication.</p>
                        <ul class="list-unstyled">
        ...
        <div class="row mb-4">
            <div class="col-md-6 mb-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">Develop fluency in spoken English with proper pronunciation and
            ...
            <div class="col-md-6 mb-4">
                <div class="card course-card h-100">
                    ...
                    <div class="card-body">
                        <p class="card-text">Build a strong foundation in English grammar with comprehensive rules and
                            practice.</p>
                        <ul class="list-unstyled">
                ...
                <div class="card master-card">
                    ...
                    <div class="card-body">
                        <p class="card-text lead">
                            Comprehensive English mastery program combining all aspects of language learning for
                            complete fluency and proficiency.
                        </p>
