        ...
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Course Content Preview</h5>
                </div>
                <div class="card-body">
                                            ...
                                            <div class="list-group list-group-flush">
                                                @foreach($module->videos as $video)
                                                    <div class="list-group-item d-flex justify-content-between align-items-center">
                                                        ...
                                                        @else
                                                            <span class="badge bg-secondary">Enroll to Watch</span>
                                                        @endif
                                                    </div>
                                                @endforeach
                                            </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    @if($course->teacher->profile && $course->teacher->profile->bio)
                        <p class="text-muted">{{ Str::limit($course->teacher->profile->bio, 150) }}</p>
                    @endif
